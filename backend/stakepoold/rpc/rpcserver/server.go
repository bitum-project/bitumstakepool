...
//
// TODO Document gRPC API like bitumwallet once the API is stable
package rpcserver
...
import (
	...
	pb "github.com/bitum-project/bitumstakepool/backend/stakepoold/rpc/stakepoolrpc"
...
const (
	...
	// error message in this case before bitumstakepool applies a client timeout.
