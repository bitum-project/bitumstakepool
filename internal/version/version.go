...
// for bitumstakepool and other utilities provided in the same repository.
package version
...
var (
	...
	// build process with:
	// '-ldflags "-X github.com/bitum-project/bitumstakepool/internal/version.PreRelease=foo"'
	...
	// build process with:
	// '-ldflags "-X github.com/bitum-project/bitumstakepool/internal/version.BuildMetadata=foo"'
