...
If you wish to run bitumstakepool from a different directory you will need to
...
- A monitoring system with alerting should be pointed at bitumstakepool and
