...
import (
	...
	"github.com/bitum-project/bitumstakepool/internal/version"
...
func (controller *MainController) APIAddress(c web.C, r *http.Request) ([]string, codes.Code, string, error) {
	...
	p, err := bitumutil.DecodeAddress(poolPubKeyAddr)
	if err != nil {
	...
	createMultiSig, err := controller.rpcServers.CreateMultisig(1, []bitumutil.Address{p, u})
	if err != nil {
...
func (controller *MainController) FeeAddressForUserID(uid int) (bitumutil.Address,
	error) {
	if uid+1 > MaxUsers {
...
func (controller *MainController) TicketAddressForUserID(uid int) (bitumutil.Address,
	error) {
	if uid+1 > MaxUsers {
		return nil, fmt.Errorf("bad uid index %v", uid)
	}
...
func (controller *MainController) AddressPost(c web.C, r *http.Request) (string, int) {
	...
	// Get bitumutil.Address for user from pubkey address string
	u, err := bitumutil.DecodeAddress(userPubKeyAddr)
	if err != nil {
...
func (controller *MainController) AdminStatus(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Title"] = "Bitum Voting Service - Status (Admin)"
...
func (controller *MainController) AdminTickets(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Title"] = "Bitum Voting Service - Tickets (Admin)"
	c.Env["Designation"] = controller.designation
...
func (controller *MainController) EmailUpdate(c web.C, r *http.Request) (string, int) {
	...
	render := func() string {
		c.Env["Title"] = "Bitum Voting Service - Email Update"
...
func (controller *MainController) EmailVerify(c web.C, r *http.Request) (string, int) {
	...
	render := func() string {
		c.Env["Title"] = "Bitum Voting Service - Email Verification"
...
func (controller *MainController) Index(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Admin"], _ = controller.isAdmin(c, r)
	c.Env["IsIndex"] = true
	c.Env["Title"] = "Bitum Voting Service - Welcome"
	c.Env["Designation"] = controller.designation
...
func (controller *MainController) PasswordReset(c web.C, r *http.Request) (string, int) {
	c.Env["Title"] = "Bitum Voting Service - Password Reset"
	session := controller.GetSession(c)
	c.Env[csrf.TemplateTag] = csrf.TemplateField(r)
...
func (controller *MainController) PasswordUpdate(c web.C, r *http.Request) (string, int) {
	...
	render := func() string {
		c.Env["Title"] = "Bitum Voting Service - Password Update"
...
func (controller *MainController) Settings(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Title"] = "Bitum Voting Service - Settings"
	c.Env["Designation"] = controller.designation
...
func (controller *MainController) Register(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Title"] = "Bitum VSP - Register"
	c.Env["Designation"] = controller.designation
...
func (controller *MainController) Tickets(c web.C, r *http.Request) (string, int) {
	...
	// Get P2SH Address
	multisig, err := bitumutil.DecodeAddress(user.MultiSigAddress)
	if err != nil {
...
func (controller *MainController) Voting(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Title"] = "Bitum Voting Service - Voting"
	c.Env["Designation"] = controller.designation
